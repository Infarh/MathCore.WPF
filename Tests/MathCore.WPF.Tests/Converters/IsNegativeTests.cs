...
/// <summary>Модульные тесты для конвертера IsNegative</summary>
[TestClass]
public class IsNegativeTests
{
    ...
    public void Convert_ZeroValue_ReturnsFalse()
    {
        ...
        Assert.That.Value(result).IsEqual(false, "Ноль не является отрицательным числом");
    }
    ...
    [TestMethod]
    public void Convert_VerySmallNegativeValue_ReturnsTrue()
    {
        IValueConverter converter = new IsNegative();
    ...
    [TestMethod]
    public void Convert_VerySmallPositiveValue_ReturnsFalse()
    {
        IValueConverter converter = new IsNegative();
    ...
    public void ConvertBack_ThrowsNotSupportedException()
    {
        ...
        Assert.ThrowsException<NotSupportedException>(() =>
            ...
            "ConvertBack не должен поддерживаться для IsNegative конвертера");
    }
