...
/// <summary>Тесты конвертера сравнения меньше или равно</summary>
[TestClass]
public class LessThanOrEqualTests
{
    /// <summary>Тест значения меньше порога</summary>
    [TestMethod]
    public void Convert_ValueLess_ReturnsTrue()
    {
        IValueConverter converter = new LessThanOrEqual(5);
    ...
    [TestMethod]
    public void Convert_ValueGreater_ReturnsFalse()
    {
        IValueConverter converter = new LessThanOrEqual(5);
    ...
    [TestMethod]
    public void Convert_ValueEqual_ReturnsTrue()
    {
        IValueConverter converter = new LessThanOrEqual(5);
