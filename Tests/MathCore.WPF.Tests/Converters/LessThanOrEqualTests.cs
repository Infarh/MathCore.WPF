...
/// <summary>Модульные тесты для конвертера LessThanOrEqual</summary>
[TestClass]
public class LessThanOrEqualTests
{
    ...
    {
        IValueConverter converter = new LessThanOrEqual { Value = 10.0 };
    ...
    {
        IValueConverter converter = new LessThanOrEqual { Value = 0.0 };
    ...
    {
        var converter = new LessThanOrEqual(42.0);
