...
//public class SwitchConverter2 : IValueConverter
//{
...
//    /// <summary>Подставляемое значение <see cref="SwitchConverter2"/></summary>
...
//    /// <param name="then">Значение <see cref="SwitchConverter2"/></param>
