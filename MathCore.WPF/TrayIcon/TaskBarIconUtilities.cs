...
/// <summary>Util and extension methods.</summary>
internal static class TaskBarIconUtilities
{
    ...
    public static Icon? ToIcon(this ImageSource? ImageSource)
    {
        ...
        if(stream_info != null) return new(stream_info.Stream);
    ...
    /// <summary>Returns a dispatcher for multi-threaded scenarios</summary>
    /// <returns></returns>
